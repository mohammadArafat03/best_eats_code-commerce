  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
        ...
        <input type="text" placeholder='Search Your Cravings' className='bg-transparent p-2 w-full focus:outline-none'/>
      </div>
      {/* Cart_Button */}
      ...
      <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-500' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-500' }>
        ...
        <nav>
          <ul className='flex flex-col p-4 text-gray-800'>
            <li className='text-xl py-4 flex'><TbTruckDelivery size={25} className="mr-4"/> Delivery</li>
            <li className='text-xl py-4 flex'><MdFavorite size={25} className="mr-4"/> Favoutites</li>
